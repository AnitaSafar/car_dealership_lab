...
public class PetrolCar extends Car {
    ...
    public PetrolCar(FuelType fuelType, String make, String model, int numOfDoors, double price, String petrolType, Windscreen windscreen, SteeringWheel steeringWheel, Engine engine, Tyre tyre, Battery battery, BrakePad brakePad) {
